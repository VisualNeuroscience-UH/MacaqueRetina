...
class ApricotData:
    ...
    def get_tonicdrive_stats(self, remove_bad_data_indices=True, viz_module=False):  # Obs?
        """
    ...
    def get_mean_temporal_filter(self, remove_bad_data_indices=True, flip_negs=True, viz_module=False):
    ...
    def get_mean_postspike_filter(self, remove_bad_data_indices=True, viz_module=False):
...
class ApricotFits(ApricotData, Viz, Mathematics):
    ...
    def fit_temporal_filters(self, normalize_before_fit=False, viz_module=False):
        """
    ...
    def fit_mean_temporal_filter(self, viz_module=False, return_df=False):
    ...
    def fit_spatial_filters(self, viz_module=False, surround_model=1, semi_x_always_major=True):
        """
        ...
        The viz_module parameter will show each DoG fit in order to search for bad cell fits and data.

        :param viz_module: boolean, whether to viz_module all fits
    ...
    def fit_all(self):
        spatial_fits = self.fit_spatial_filters(viz_module=False, surround_model=1, semi_x_always_major=True)
...
if __name__ == '__main__':
    ...
    a.fit_temporal_filters(viz_module=True, normalize_before_fit=True)
